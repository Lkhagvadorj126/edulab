  ...
  angilal: {
    ...
    tests: [
      ...
      },
      {
        ...
        options: ["Давсагт", "Сувганцарт", "Түүдгэнцэрт", "Сүвэнд"],
        answer: "Түүдгэнцэрт",
      },
      {
        question: "Шээс түр хадгалах эрхтэн?",
        options: ["Бөөр", "Давсаг", "Суваг", "Вена"],
        answer: "Давсаг",
      },
      {
        question: "Биеийн тогтмол байдлыг юу гэх вэ?",
        options: ["Фотосинтез", "Гомеостаз", "Митиоз", "Мутаци"],
        answer: "Гомеостаз",
      },
      {
        question: "Шээс дамжуулах хоолой?",
        options: ["Артери", "Вена", "Шээс дамжууруур", "Капилляр"],
    ...
    tests: [
      {
        ...
        options: ["Лигаза", "Амилаза", "Пепсин", "Рестрикци"],
        answer: "Лигаза",
      },
      {
        question: "Тээвэрлэгч цагираг ДНХ?",
        options: ["Хромосом", "Плазмид", "Геном", "Рибосом"],
        answer: "Плазмид",
      },
      {
      ...
      },
      {
        ...
        options: ["Элэг", "Бөөр", "Нойр булчирхай", "Зүрх"],
        answer: "Нойр булчирхай",
      },
      {
        question: "Генийг зүсэх фермент?",
        options: ["Лигаза", "Рестрикци", "Полимераза", "Хеликаза"],
        answer: "Рестрикци",
      },
    ],
    cards: [
  ...
  es: {
    ...
    tests: [
      ...
      },
      {
        ...
        options: ["Гипоталамус", "Нугас", "Зүрх", "Элэг"],
        answer: "Гипоталамус",
      },
      {
        question: "Хурдан зохицуулга аль нь вэ?",
        options: ["Мэдрэл", "Шингэн", "Арьс", "Бөөр"],
        answer: "Мэдрэл",
      },
      {
        question: "Импульс дамжих хэсэг?",
        options: ["Аксон", "Цөм", "Давсаг", "Вектор"],
        answer: "Аксон",
      },
    ],
    cards: [
