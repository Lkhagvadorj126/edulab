  ...
  return (
    <main className="min-h-screen bg-[#F8FAFC]">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 pt-32 pb-20 relative z-20">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            {isTeacher && (
              <Link
                ...
                className="bg-[#312C85] text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-lg hover:shadow-indigo-200 transition-all flex items-center gap-2"
              >
        ...
        {/* БАГШ БИШ ҮЕД Л NAVBAR ХАРАГДАНА */}
        {!isTeacher && (
          <div className="mb-8">
            <Navbar />
          </div>
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none -z-10 opacity-40">
        <div className="absolute top-[10%] left-[-5%] w-[30%] h-[30%] bg-[#312C85]/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-[10%] right-[-5%] w-[25%] h-[25%] bg-[#312C85]/10 rounded-full blur-[100px]" />
      </div>
    </main>
  );
}
