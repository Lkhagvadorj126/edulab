...
function TestContent() {
  ...
  const loadTests = useCallback(async () => {
    ...
    try {
      ...
      // 3. Хоёр датаг нэгтгэх (Динамик датаг эхэнд нь reverse хийж гаргана)
      ...
      <AnimatePresence mode="wait">
        {!finished ? (
          ...
          >
            ...
            {/* Хэрэв асуулт зурагтай бол харуулна */}
            {currentQ.image && (
              <div className="mb-8 rounded-2xl overflow-hidden border border-slate-100 shadow-sm max-h-[300px]">
                <img
                  src={currentQ.image}
            ...
            <div className="grid gap-4">
              {currentQ.options?.map((opt, i) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`w-10 h-10 rounded-xl flex items-center justify-center text-xs font-black shadow-sm transition-all ${isSelected ? "bg-white" : "bg-slate-200"}`}
                    >
