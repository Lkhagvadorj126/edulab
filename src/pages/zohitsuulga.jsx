...
export default function ZohitsuulgaPage() {
  return (
          ...
          <div className="p-8 md:p-12">
            <div className="prose prose-slate max-w-none">
              ...
              <p className="text-lg text-slate-600 leading-relaxed mb-10 font-medium">
                Хүний бие махбод гадаад орчны өөрчлөлтөөс үл хамааран дотоод
                орчноо (температур, сахарын хэмжээ, усны тэнцвэр) тогтвортой
                хадгалахыг <strong>Гомеостаз</strong> гэнэ.
              </p>

              {/* Зохицуулгын хэлбэрүүд - Grid */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                <div className="bg-slate-50 p-6 rounded-[30px] border border-slate-100 group hover:border-[#312C85]/30 transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    <Thermometer className="text-[#312C85]" size={20} />
                    <h4 className="font-black text-slate-800 m-0">
                      Дулааны зохицуулга
                    </h4>
                  </div>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Тархины <strong>гипоталамус</strong> нь дулааны төв болж,
                    арьсны судас өргөсөх, нарийсах болон хөлс ялгаруулах
                    процессыг хянадаг.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 p-6 rounded-[30px] border border-slate-100 group hover:border-[#312C85]/30 transition-all">
                  <div className="flex items-center gap-3 mb-4">
                    <Droplets className="text-[#312C85]" size={20} />
                    <h4 className="font-black text-slate-800 m-0">
                      Шингэний зохицуулга
                    </h4>
                  </div>
                  <p className="text-sm text-slate-500 leading-relaxed">
                    Дотоод шүүрлийн булчирхайнууд даавар ялгаруулж, цусан дахь
                    глюкоз болон бусад бодисын хэмжээг тогтворжуулна.
                  </p>
                </div>
              </div>

              {/* Арьсны бүтэц ба Нойр булчирхай - Highlight List */}
              <div className="bg-[#312C85]/5 rounded-[35px] p-8 md:p-10 border border-[#312C85]/10">
                <div className="flex items-center gap-3 mb-8">
                  <Fingerprint className="text-[#312C85]" />
                ...
                <ul className="space-y-8 m-0 p-0 list-none">
                  {[
                    {
                      title: "Арьсны 3 давхарга",
                      desc: "Эпидермис (өнгөн), Дермис (жинхэнэ), Гиподермис (өөхөн). Арьс нь дулаан зохицуулах хамгийн том эрхтэн юм.",
                    },
                    {
                      title: "Лангергансын арал",
                      desc: "Нойр булчирхайн α-эсээс глюкагон, β-эсээс инсулин ялгарч цусан дахь сахарыг эсрэгээр зохицуулна.",
                    },
                    {
                      title: "Инсулины үүрэг",
                      desc: "Цусан дахь сахарын хэмжээг бууруулна. Дутагдвал чихрийн шижин өвчин үүсэх үндэс болдог.",
                    },
                  ].map((point, idx) => (
