...
// Үндсэн тогтмол сэдвүүд (бүх ангид харагдана)
...
export default function GeographyPage() {
  ...
  const fetchTopics = useCallback(async () => {
    ...
    // Ангигүй бол динамик дата татах шаардлагагүй
    ...
    try {
      ...
      const url = `/api/physics-topics?category=geography&classCode=${user.classCode}&t=${Date.now()}`;
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-[#312C85]/40 backdrop-blur-md flex items-center justify-center z-[100] p-4">
          <div className="bg-white rounded-[40px] p-8 md:p-10 w-full max-w-lg relative animate-in zoom-in-95 duration-200 shadow-2xl">
            ...
            <h2 className="text-2xl font-black text-[#312C85] mb-8 uppercase text-left tracking-tighter">
              {editingId ? "Сэдэв засах" : "Шинэ сэдэв нэмэх"}
            </h2>
            <form onSubmit={handleSubmit} className="space-y-5 text-left">
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2 ml-2 block">
                  Сэдвийн гарчиг
                </label>
                <input
                  required
                  ...
                  placeholder="Жишээ: Агаарын мандал"
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Хичээлийн агуулгыг товч тайлбарлах..."
                  value={formData.desc}
                  onChange={(e) =>
