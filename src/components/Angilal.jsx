...
const INITIAL_DATA = {
  ...
  theory: [
    {
      title: "Ангилал зүйн шатлал",
      content: [
        "Аймаг → Хүрээ → Анги → Баг → Овог → Төрөл → Зүйл.",
        "Хамгийн бага нэгж нь Зүйл (Species) юм.",
        "Карл Линней ангилал зүйн үндэсийг тавьсан.",
      ],
    },
    {
      title: "Хоёр нэршлийн зарчим",
      content: [
        "Амьд биеийг Төрөл ба Зүйлийн нэрээр нэрлэнэ (Бинар нэршил).",
        "Жишээ нь: *Homo sapiens* (Ухаант хүн).",
        "Эхний үсэг томоор, итали хэлбэрээр бичигддэг.",
      ],
    },
    {
      title: "Амьд байгалийн 5 аймаг",
      content: [
        "Монера (Бактери), Протиста (Эгэл биетэн).",
        "Мөөг, Ургамал, Амьтны аймаг.",
        "Тэжээл болон бүтцийн онцлогоор нь ялгадаг.",
      ],
    },
    {
      title: "Сээр нуруутан амьтад",
      content: [
        "Загас, Хоёр нутагтан, Мөлхөгчид.",
        "Шувуу, Сүүн тэжээлтэн.",
        "Биеийн температур ба үржлийн хэлбэрээрээ ялгаатай.",
      ],
    },
    {
      title: "Сээр нуруугүй амьтад",
      content: [
        "Үе хөлтөн (Шавж, Хавч хэлбэртэн, Аалз хэлбэртэн).",
        "Зөөлөн биетэн, Хөндий биетэн.",
        "Дэлхий дээрх амьтдын дийлэнх хувийг эзэлдэг.",
      ],
    },
    {
      title: "Ургамлын ангилал",
      content: [
        "Доод ургамал (Замаг), Дээд ургамал (Хөвд, Шивэрс).",
        "Нүцгэн үртэн (Нарс, Гацуур).",
        "Далд үртэн буюу Цэцэгт ургамал (Хамгийн өндөр хөгжилтэй).",
      ],
    },
    {
      title: "Вирус - Амьд ба Амьгүй",
      content: [
        "Эсийн бүтэцгүй, зөвхөн амьд эзэн эс дотор үржинэ.",
        "Уургийн бүрхүүл ба нуклейн хүчлээс (ДНХ/РНХ) тогтоно.",
        "Бие даан бодисын солилцоо явуулдаггүй.",
      ],
    },
  ],
};
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs flex items-center gap-1">
                <BrainCircuit size={12} /> {INITIAL_DATA.page.subtitle}
              </p>
            </div>
          </div>
          <button
            ...
            <div className="flex justify-between items-center px-1">
              ...
              {isTeacher && (
                <button
                  ...
                  className="p-1.5 bg-[#312C85] text-white rounded-lg hover:bg-black transition-all"
                >
                  ...
                  >
                    <div className="h-28 rounded-xl bg-slate-100 overflow-hidden relative">
                      <img
                        src={
                          exp.img ||
                          "https://images.unsplash.com/photo-1541014741259-df549cae7744?w=400"
                        }
