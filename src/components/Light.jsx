  ...
  theory: [
    {
      ...
      content: [
        "Гэрэл тольлог гадаргуу дээр тусахад тусгалын өнцөг α нь ойлтын өнцөгтэй β үргэлж тэнцүү байна.",
        "Томьёо: α = β",
      ],
    },
    {
      ...
      content: [
        "Гэрэл нэг орчноос нөгөө орчинд шилжихдээ тархалтын чиглэлээ өөрчлөх үзэгдэл.",
        "Снеллиусын хууль: n₁ · sin(α) = n₂ · sin(β)",
      ],
    },
    {
      title: "Орчны хугарлын илтгэгч",
      content: [
        "Вакуум дахь гэрлийн хурдыг тухайн орчин дахь хурдад харьцуулсан харьцаа.",
        "Томьёо: n = c / v",
      ],
    },
    {
      ...
      content: [
        "Бие хүртэлх зай (d), дүрс хүртэлх зай (f) ба фокусын зайн (F) хамаарал.",
        "Томьёо: 1/F = 1/d + 1/f",
      ],
    },
  ],
