...
export default function Nav() {
  ...
  // Класс тодорхойлолт
  const baseClass =
    "px-4 py-3 rounded-xl transition-all duration-300 font-black text-[13px] text-center uppercase tracking-wider";
  const desktopClass = "flex-1 mx-0.5";
  const mobileClass = "w-full mb-1 text-left px-6";

  // Өнгөний өөрчлөлт: #312C85
  const activeClass =
  ...
  const links = [
    { href: "/indexP", label: "Нүүр" },
    { href: "/motion", label: "Хөдөлгөөн ба механик" },
    { href: "/sound", label: "Дуу ба долгион" },
    { href: "/heat", label: "Дулаан" },
    { href: "/quantum", label: "Квантын үзэгдэл" },
    { href: "/light", label: "Гэрэл ба цацраг" },
    { href: "/energy", label: "Цахилгаан ба соронзон" },
  ];
