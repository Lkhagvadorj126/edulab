...
const INITIAL_DATA = {
  ...
  experiments: [
    ...
    {
      title: "Цусны даралт",
      href: "https://phet.colorado.edu/sims/html/fluid-pressure-and-flow/latest/fluid-pressure-and-flow_all.html",
      img: "https://phet.colorado.edu/sims/html/fluid-pressure-and-flow/latest/fluid-pressure-and-flow-600.png",
    },
    {
      title: "Эсийн амьсгал",
  ...
  theory: [
    {
      ...
      content: [
        "Хамар → Залгиур → Мөгөөрсөн хоолой → Бронх → Уушги.",
        "Уушгины цулцан (Альвеоль) дээр хийн солилцоо явагдана.",
        "Агаарыг шүүх, бүлээсгэх, чийгшүүлэх үүрэгтэй.",
      ],
    },
    {
      title: "Эсийн амьсгал",
      content: [
        "Аэроб: Хүчилтөрөгчийн оролцоотой (Их энерги үүснэ).",
        "Анаэроб: Хүчилтөрөгчгүй орчинд (Сүүн хүчил үүснэ).",
        "Глюкоз задарч АТФ (энерги) ба $CO_2$ үүсгэх процесс.",
      ],
    },
    {
      title: "Цусны бүтэц",
      content: [
        "Сийвэн: Ус, эрдэс, шим тэжээл агуулсан шингэн хэсэг.",
        "Улаан эс (Эритроцит): Хүчилтөрөгч зөөвөрлөнө.",
        "Цагаан эс (Лейкоцит): Бактери, вирусаас хамгаална.",
      ],
    },
    {
      title: "Цусны эргэлтийн тогтолцоо",
      content: [
        "Зүрх: Цусыг шахах булчинлаг эрхтэн.",
        "Артери: Зүрхнээс гарсан хүчилтөрөгчөөр баялаг цус (Уушгины артериас бусад).",
        "Вена: Зүрх рүү очиж буй $CO_2$-оор баялаг цус.",
      ],
    },
    {
      title: "Хийн шилжилт (Диффуз)",
      content: [
        "Хийнүүд концентраци ихтэй газраасаа бага руугаа шилжинэ.",
        "Цулцан дахь хүчилтөрөгч цусанд орно.",
        "Цусан дахь нүүрсхүчлийн хий цулцан руу орж гадагшилна.",
      ],
    },
    {
      title: "Зүрхний бүтэц",
      content: [
        "4 тасалгаатай: 2 тосгуур, 2 ховдол.",
        "Зүүн ховдлын хана хамгийн зузаан (бүх бие рүү цус шахдаг).",
        "Хавхлагууд цусны урсгалыг нэг чиглэлд байлгана.",
      ],
    },
    {
      title: "Тунгалгийн тогтолцоо",
      content: [
        "Эд эсийн шингэнийг буцааж цусанд хүргэнэ.",
        "Тунгалгийн зангилаанууд бактерийг шүүж устгана.",
        "Өөх тосны шимэгдэлтэд оролцдог.",
      ],
    },
  ],
};

export default function Amisgal() {
  const { user } = useAuth();
      ...
      <section className="pt-24 md:pt-28">
        <div className="flex bg-white py-4 px-5 rounded-2xl shadow-sm justify-between items-center border border-slate-200 mb-6">
          <div className="flex items-center">
            <Link
              href="/biology"
              className="mr-4 p-2 hover:bg-slate-100 rounded-xl transition-all transition-transform active:scale-90"
            >
        ...
        <section className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-slate-200 mt-12">
          <div className="flex flex-col items-center mb-10">
            <h2 className="text-2xl md:text-3xl text-slate-900 font-black uppercase flex items-center gap-3">
              <Wind className="text-[#312C85]" size={32} /> Онолын мэдээлэл
            </h2>
