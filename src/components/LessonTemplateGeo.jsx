      ...
      <div className="max-w-[1400px] mx-auto mt-6">
            ...
            <div className="bg-white p-4 rounded-2xl border border-[#312C85]/20 shadow-sm">
              ...
              {activePanel === "test" && (
                <div className="space-y-2 animate-in slide-in-from-top-1">
                  ...
                  {/* Энд зөвхөн 3 input харагдана */}
                  {newTest.options.slice(0, 3).map((opt, idx) => (
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="w-full lg:w-[75%] space-y-4">
            ...
            {/* Canva Embed Input - Зөвхөн багш харна */}
            {isTeacher && (
