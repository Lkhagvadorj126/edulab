...
const INITIAL_DATA = {
  ...
  theory: [
    {
      title: "Физик хэмжигдэхүүн",
      content: [
        "Биеийн болон үзэгдлийн шинж чанарыг тоогоор илэрхийлэхийг хэлнэ.",
        "Жишээ нь: Урт (l), Хугацаа (t), Масс (m).",
      ],
    },
    {
      title: "Хэмжилтийн алдаа",
      content: [
        "Хэмжсэн утга ба бодит утгын зөрүүг хэлнэ.",
        "Үнэмлэхүй алдаа ба харьцангуй алдаа гэж ангилдаг.",
      ],
    },
    {
      title: "Шууд ба Шууд бус хэмжилт",
      content: [
        "Шууд: Багажаар шууд унших (Шугам, Термометр).",
        "Шууд бус: Томьёо ашиглан тооцоолох (Хурд, Талбай).",
      ],
    },
    {
      title: "Нарийвчлал ба Хуваарийн утга",
      content: [
        "Багаж бүр өөрийн гэсэн хамгийн бага хуваарийн утгатай.",
        "Хэмжилтийн алдаа нь хуваарийн утгын хагасаас хэтрэхгүй байх ёстой.",
      ],
    },
  ],
};
