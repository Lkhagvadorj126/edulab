...
const INITIAL_DATA = {
  ...
  theory: [
    {
      title: "Молекулын туйлшрал гэж юу вэ?",
      content: [
        "Гадаад цахилгаан орны нөлөөгөөр молекул дахь эерэг ба сөрөг цэнэгүүд бага зэрэг шилжиж, диполь үүсэхийг хэлнэ.",
        "Энэ нь бодисын диэлектрик шинж чанарыг тодорхойлдог.",
      ],
    },
    {
      title: "Цахилгаан диполь момент",
      content: [
        "Диполийг тодорхойлох үндсэн хэмжигдэхүүн.",
        "Томьёо: p = q * l",
        "Нэгж: Кл·м (Кулон метр).",
      ],
    },
    {
      title: "Туйлтай ба Туйлгүй молекул",
      content: [
        "Туйлтай: Ус (H₂O), Аммиак (NH₃)",
        "Туйлгүй: Хүчилтөрөгч (O₂), Метан (CH₄)",
      ],
    },
    {
      title: "Конденсатор ба Диэлектрик",
      content: [
        "Ялтсуудын хооронд диэлектрик хийхэд багтаамж ε дахин нэмэгддэг.",
        "Томьёо: C = ε * C₀",
      ],
    },
  ],
            ...
            <div className="mb-10 p-6 bg-indigo-50/30 rounded-2xl border-2 border-dashed border-indigo-200 flex flex-col gap-4 animate-in slide-in-from-top duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <textarea
                  ...
                  placeholder="Агуулга (Мөр бүрийг шинэ мөрөөр салгана уу)..."
