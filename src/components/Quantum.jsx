...
const INITIAL_DATA = {
  ...
  theory: [
    {
      title: "1. Квантын гипотез",
      content: [
        "Энерги нь тасралтгүй биш, харин тодорхой порц буюу квант-аар цацагддаг.",
        "Үндсэн томьёо: E = h·f",
        "Планкийн тогтмол: 6.626 × 10⁻³⁴ Ж·с",
      ],
    },
    {
      title: "2. Фотоэффектийн тэгшитгэл",
      content: [
        "Гэрэл металлын гадаргад тусах үед электронууд сугаран гарах үзэгдэл.",
        "Тэгшитгэл: h·f = A + Eₖ",
        "A - гарах ажил, Eₖ - кинетик энерги.",
      ],
    },
    {
      title: "3. Фотоны импульс",
      content: [
        "Фотон массгүй боловч импульстэй байна.",
        "Импульс: p = h/λ = E/c",
        "Энэ нь гэрлийн бөөмлөг чанарыг баталдаг.",
      ],
    },
    {
      title: "4. Де Бройлийн долгион",
      content: [
        "Микро биетүүд нь бөөм болон долгионы хоёрдогч чанартай.",
