...
export default function NavH() {
  ...
  const links = [
    { href: "/indexH", label: "Нүүр" },
    { href: "/diffusion", label: "Диффуз" },
    { href: "/molecular", label: "Молекулын туйлшрал" },
    { href: "/measurement", label: "Квантын хэмжилт" },
    { href: "/density", label: "Нягтрал" },
    { href: "/laser", label: "Лазер" },
  ];
