  ...
  theory: [
    {
      ...
      content: [
        "Лавлах систем: Биеийн хөдөлгөөнийг ажиглах цэг.",
        "Шилжилт: Вектор.",
        "Хурд: v = s/t",
      ],
    },
    {
      title: "Хөдөлгөөний төрлүүд",
      content: ["Тэгш хөдөлгөөн: s = v₀t", "Хурдсах: v = v₀ + at"],
    },
    { title: "Чөлөөт уналт", content: ["g = 9.8 м/с²", "h = ½gt²"] },
    { title: "Нумралт ба шидэлт", content: ["Алслалт: R = v₀²sin2θ / g"] },
  ],
};
